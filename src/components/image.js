    ...
    render={data => {
      switch (name.toLowerCase()) {
        case "servizecover":
          return (
            <Img
              className="workCoverImageMain"
              fixed={data.servizeCover.childImageSharp.fixed}
            />
          );
        case "ezencielcover":
          return (
            <Img
              className="workCoverImageMain"
              fixed={data.ezencielCover.childImageSharp.fixed}
            />
          );
        case "byroadcover":
          return (
            <Img
              className="workCoverImageMain"
              fixed={data.byroadCover.childImageSharp.fixed}
            />
          );
        case "ezenciel":
        ...
        case "ezencieldesktop":
          return (
            <Img
              className="workCoverImage"
              fixed={data.ezencielDesktop.childImageSharp.fixed}
            />
          );
        case "servizedesktop":
          return (
            <Img
              className="workCoverImage"
              fixed={data.servizeDesktop.childImageSharp.fixed}
            />
          );
        case "byroaddesktop":
          return (
            <Img
              className="workCoverImage"
              fixed={data.byroadDesktop.childImageSharp.fixed}
            />
          );
        case "background":
          return (
            <Img
              style={{ marginLeft: 1000, height: 900, width: 900 }}
